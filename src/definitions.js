...
*	{boolean} the result
*/
function IsEqualWithEps (a, b, eps)
{
...
export {
	IsZero, IsPositive, IsNegative, IsLower, IsGreater, IsEqual, IsEqualWithEps, IsLowerOrEqual, IsGreaterOrEqual, Minimum, Maximum, ArcSin, ArcCos
};